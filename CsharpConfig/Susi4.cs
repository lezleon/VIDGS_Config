...
namespace Susi4.APIs
{
    ...
    public static class SusiBoard
    {
        ...
        public const UInt32 SUSI_ID_HWM_VOLTAGE_MAX = 20;
    ...
    public static class SusiGPIO
    {
        ...
        public static DeviceInfo Dev = null;
        public static List<DevPinInfo> DevPinList = new List<DevPinInfo>();
        public static DevPinInfo DevPin = null;
        ...
        private static UInt32 GetID()
        {
            return Dev.ID;
        }

        private static UInt32 GetMask()
        {
            return 0xFFFFu;
        }

        public static bool InitializeLib()
        {
            ...
            {
                //System.Windows.Forms.MessageBox.Show("Unable to load DLL 'Susi4.dll'.\nBe sure SUSI 4.0 has been installed.", "Error");
                return false;
            }

            if (Status != SusiStatus.SUSI_STATUS_SUCCESS)
            {
                //System.Windows.Forms.MessageBox.Show(String.Format("SusiLibInitialize() failed. 0x{0:X8}", Status));
                return false;
            }
